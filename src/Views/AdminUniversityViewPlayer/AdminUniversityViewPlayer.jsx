...
//getByObjectId
const AdminUniversityPlayerView = () => {
  ...
  useEffect(() => {
    ...
    Axios.get(process.env.REACT_APP_API_URL + '/player/getByObjectId', {params: {ids:[playerId]}}, {
        headers: {},
      })
        .then((res) => {
          console.log(res.data.data);
          setPlayerDetails(res.data.data[0]);
...
export default AdminUniversityPlayerView;

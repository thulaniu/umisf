...
import Styles from "./FinishedMatchDouble.module.css";
import { Table } from "react-bootstrap";
import { useLocation } from 'react-router-dom';
import { determineWinningRounds } from "./helpers/determineWinningRounds";

const FinishedMatchDouble = (props) => {
    return (
        ...
        <div className={`${Styles["card"]} align-items-center`}>
          <div className={`${Styles["card-header"]} row`}>
            ...
            >
              ...
              />
                            <img
                src={props.obj.playerOne.partner.photo}
                alt={props.obj.playerOne.partner.firstName + " " + props.obj.playerOne.partner.lastName}
                className={`${Styles["dp"]} ${Styles["dp-left"]}`}
              />
            </div>
            <div
            ...
            >
              ...
              />
                            <img
                src={props.obj.playerTwo.partner.photo}
                alt={props.obj.playerTwo.partner.firstName + " " + props.obj.playerTwo.partner.lastName}
                className={`${Styles["dp"]} ${Styles["dp-right"]}`}
              />
            </div>
          </div>
          ...
          <div className={`${Styles["table-container"]} ${Styles["fadeIn"]} row align-items-center`}>
            <Table size="sm" className={`${Styles["table"]} text-center`}>
              <thead>
                <tr>
                  <th>{props.obj.playerOne.player.firstName} {" & "} {props.obj.playerOne.partner.firstName}</th>
                  <th>Vs</th>
                  <th>{props.obj.playerTwo.player.firstName} {" & "} {props.obj.playerTwo.partner.firstName}</th>
                </tr>
              </thead>
              <tbody>
                <tr>
...
export default FinishedMatchDouble;